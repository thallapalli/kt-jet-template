...
1. Theming - adding redwood theme to the app.
    In your application, open the /projectname/oraclejetconfig.json file and change the key "defaultTheme" to "redwood"

2. Hybrid App Configuration
  a. Extend to hybrid project:
    ojet add hybrid --platforms=android,ios,windows --appid=com.jet.fixitfastredwood --appname=FixItFastRedwood
