...
define(['ojs/ojcore', 'knockout', 'jquery', 'appController',
        'appUtils', 'dataService', 'oraclemapviewer'], function(oj, ko, $, app, appUtils, data) {
  function incidentsTabMap() {
    var self = this;
  ...
  ko.bindingHandlers.incidentsMap = {
    init: function (element, valueAccessor, allBindingsAccessor, viewModel) {
      ...
      mapObj.incidents.subscribe(function (mapObj) {
        ...
        mapObj.forEach(function(incident, index){
        ...
        // mapObj.forEach(function(incident){
