...
define({
  "errorMessages" : {
    ...
    "P1016":"Attempt to enable fingerprint when passcode is not enabled.",
    "P1017":"Attempt to disable passcode when fingerprint is enabled.",
    "P1018":"Error while enabling local authenticator.",
    "P1019":"Either the device does not support it or fingerprint is not enrolled.",
    "P1020":"Attempt to change passcode when passcode is not enabled.",
