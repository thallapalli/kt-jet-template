...
'use strict';
define(['ojs/ojcore', 'knockout', 'dataService', 'appUtils', 'mapping', 'PushClient', 'OfflineController',
...
function (oj, ko, data, appUtils, mapping, PushClient, OfflineController, ConnectionDrawer, moduleHelper, imageHelper, authErrTrsl) {
  ...
  function AppControllerViewModel() {
    ...
    self.isPhotoSelectionInProgress = function() {
